...
foth = open("%s-clean-sameangle.csv"  % project_name, "w")
...
foth.write("subject_id,x,y,rx,ry,angle\n")
        ...
        if len(anno['value']) < 1:
            ...
            for i_v, thevalue in enumerate(anno['value']):
                ...
                if thevalue['x'] > thevalue['y']:
                    ...
                    foth.write("%d,%.2f,%.2f,%.2f,%.2f,%.2f\n" % (subject_id, thevalue['x'], thevalue['y'], thevalue['rx'], thevalue['ry'], thevalue['angle']))
